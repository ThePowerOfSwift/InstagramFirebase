...
//  InstagramFirebase
//
//  Created by Anson Ng on 30/3/18.
...
class PreviewPhotoContainerView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        saveButton.anchor(top: nil, left: leadingAnchor, bottom: bottomAnchor, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
    }
